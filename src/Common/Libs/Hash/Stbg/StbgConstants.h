#ifndef __STREEBOG_CONSTANS_H__
#define __STREEBOG_CONSTANS_H__

#include <array>
#include <cinttypes>
typedef union _uint512_t 
{
   uint64_t qword[8];
   uint8_t  byte[64];
}uint512_t;

namespace StbgConstants
{
//Таблица для нелинейного биективного преобразования множества двоичных векторов (подстановки)
static const
std::array<uint8_t, 256> Pi={
...
//Таблица для линейного преобразования множества двоичных векторов
static const
std::array<decltype(0x8e20faa72ba0b470), 64> A = {
